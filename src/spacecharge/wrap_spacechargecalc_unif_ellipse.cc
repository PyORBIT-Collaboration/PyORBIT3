...
#include "wrap_spacechargecalc_unif_ellipse.hh"
...
// initializator for python SpaceChargeCalcUnifEllipse2D class
static int SpaceChargeCalcUnifEllipse2D_init(pyORBIT_Object *self, PyObject *args, PyObject *kwds) {
    int nEllipses = 1;
    if (!PyArg_ParseTuple(args, "|i:__init__", &nEllipses)) {
        ORBIT_MPI_Finalize("PySpaceChargeCalcUnifEllipse2D - SpaceChargeCalcUnifEllipse2D([nEllipses = 1]) - constructor needs parameters.");
    }
    self->cpp_obj = new SpaceChargeCalcUnifEllipse2D(nEllipses);
    return 0;
}
...
static PyTypeObject pyORBIT_SpaceChargeCalcUnifEllipse_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "SpaceChargeCalcUnifEllipse", /*tp_name*/
...
static PyTypeObject pyORBIT_SpaceChargeCalcUnifEllipse2D_Type = {
    PyVarObject_HEAD_INIT(NULL, 0) "SpaceChargeCalcUnifEllipse2D", /*tp_name*/
    sizeof(pyORBIT_Object),                                              /*tp_basicsize*/
    0,                                                                   /*tp_itemsize*/
    (destructor)SpaceChargeCalcUnifEllipse_del,                  /*tp_dealloc*/
    0,                                                                   /*tp_print*/
    ...
    0,                                                                   /*tp_as_buffer*/
    Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE,                            /*tp_flags*/
    "The SpaceChargeCalcUnifEllipse2D python wrapper",             /* tp_doc */
    0,                                                                   /* tp_traverse */
    0,                                                                   /* tp_clear */
    0,                                                                   /* tp_richcompare */
    0,                                                                   /* tp_weaklistoffset */
    ...
    0,                                                                   /* tp_descr_set */
    0,                                                                   /* tp_dictoffset */
    (initproc)SpaceChargeCalcUnifEllipse2D_init,                   /* tp_init */
    0,                                                                   /* tp_alloc */
    SpaceChargeCalcUnifEllipse_new,                              /* tp_new */
};
...
void initSpaceChargeCalcUnifEllipse(PyObject *module) {
    if (PyType_Ready(&pyORBIT_SpaceChargeCalcUnifEllipse_Type) < 0)
        return;
    ...
    if (PyType_Ready(&pyORBIT_SpaceChargeCalcUnifEllipse2D_Type) < 0)
        return;
    Py_INCREF(&pyORBIT_SpaceChargeCalcUnifEllipse2D_Type);
    PyModule_AddObject(module, "SpaceChargeCalcUnifEllipse2D", (PyObject *)&pyORBIT_SpaceChargeCalcUnifEllipse2D_Type);
}
