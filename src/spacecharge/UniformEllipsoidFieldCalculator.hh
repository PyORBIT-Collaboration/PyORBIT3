...
class UniformEllipsoidFieldCalculator : public OrbitUtils::CppPyWrapper {
  public:
    ...
    /** Sets the half-axes of the ellipse. */
    void setEllipse(double a_in, double b_in);
    ...
    /** Calculates the field components of a uniformly charged ellipse. */
    void calcField2D(double x, double y, double x2, double y2,
                     double &ex, double &ey);
