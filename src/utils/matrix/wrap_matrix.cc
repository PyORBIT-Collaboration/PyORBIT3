...
extern "C" {
  ...
  static PyMethodDef MatrixClassMethods[] = {
    ...
    { "set",        Matrix_get_set   ,METH_VARARGS,"Sets the new value to (i,j) element - set (i,j,val)"},
		...
		{ "transpose",  Matrix_transpose ,METH_VARARGS,"Transposes the matrix. Returns a new matrix."},
		{ "invert",     Matrix_invert    ,METH_VARARGS,"Returns the new inverted matrix, or None. Returns a new matrix."},
